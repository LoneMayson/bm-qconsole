...
Процедура Настройки(Команда)
	...
	ОткрытьФорму(ИмяФормыОбработки("ФормаОтчетДвиженияДокументаНастройки"), ПараметрыОткрытия, ЭтотОбъект, УникальныйИдентификатор, , , Оповещение);
...
Функция ПолучитьПараметрыМакета()
	...
	Макет = РеквизитФормыВЗначение("Объект").ПолучитьМакет("ОтчетДвиженияДокументаМакет");
	...
	ПараметрыМакета.Вставить("ЦветЗаголовокРегистра", 			Новый Цвет(51, 51, 153));
